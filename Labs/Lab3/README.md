...
```bash
wget -nc -O ~/.vimrc https://raw.githubusercontent.com/Purdue-CSUSB/CS-193-S2017/master/labs/lab4/vimrc
```
...
```bash
wget -N -P ~ https://raw.githubusercontent.com/Purdue-CSUSB/CS-193-S2017/master/labs/lab4/buggy-drjava.tar.gz
```
